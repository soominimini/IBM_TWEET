...
def init_page():
    if request.method=='GET':
        ...
        ret_category1 = {personality['consumption_preference_id']: personality['score'] for personality in  profile['consumption_preferences'][0]['consumption_preferences']}
        ...
        ret_category2 = {personality['consumption_preference_id']: personality['score'] for personality in profile['consumption_preferences'][1]['consumption_preferences']}
        ret_category3 = {personality['consumption_preference_id']: personality['score'] for personality in  profile['consumption_preferences'][2]['consumption_preferences']}
        ret_category4 = {personality['consumption_preference_id']: personality['score'] for personality in profile['consumption_preferences'][3]['consumption_preferences']}
        ret_category5 = {personality['consumption_preference_id']: personality['score'] for personality in profile['consumption_preferences'][4]['consumption_preferences']}
        ret_category6 = {personality['consumption_preference_id']: personality['score'] for personality in profile['consumption_preferences'][5]['consumption_preferences']}
        ret_category7 = {personality['consumption_preference_id']: personality['score'] for personality in  profile['consumption_preferences'][6]['consumption_preferences']}
        ret_category8 = {personality['consumption_preference_id']: personality['score'] for personality in  profile['consumption_preferences'][7]['consumption_preferences']}
        #총 8개의 대분류
     #   print(ret_category1)
      #  print(ret_category2)
       # print(ret_category3)
